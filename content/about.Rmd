...
My name is Nathaniel Woodward (*né* Raley) and I am a data science professional with [Indeed.com](https://www.indeed.com), where every day I help people get jobs. 

Previously, I was a faculty member in the [Department of Statistics and Data Sciences](https://stat.utexas.edu/) at UT Austin, where I earned both MS (2016) and PhD (2018) while working as a researcher and statistical consultant.
...
For some examples of my past work, see the [portfolio](/portfolio/) page.
...
Despite the impression you may have gotten from my overwrought prose style,[^25] I am extremely economical and I abominate waste, especially that of time (the thing I value most highly) or money (which I must sell my time to get).[^13]
...
<<<<<<< HEAD
Besides, I like indoor activities best! I enjoy pestering my[^6] four [^7] cats[^8] juggling,[^9] puzzling (sweeping mines,[^2] crossing words[^16][^38]), [quizzing](https://www.naqt.com/stats/school/players.jsp?org_id=1009), recreational [reading](https://www.goodreads.com/user/show/44370058-nathaniel) and mathematics (here's [a fun one I saw recently](https://www.janestreet.com/join-jane-street/open-positions/?utm_content=sierpinski)), eating spicy and/or fermented[^3] things in accordance with lax (read: lapsed) veganism[^21] (basically, I'll eat cheese if it's going to waste or difficult to avoid). ~As of August 2019, I now have two hens (Nina and Maria), both of whom lay eggs, which I also eat!~ As of December 2022, I now have 7 hens (Nina, Big Buff, Little Buff, Ida, Franny, Tuppy, Olive), 2 roosters (Bertram and Cheddar), and 4 guinea fowl (Connor, Al, Egg, and Pepper).
=======
Besides, I like indoor activities best! I enjoy pestering my[^6] three[^7] cats,[^8] juggling,[^9] puzzling (sweeping mines,[^2] crossing words[^16]), [quizzing](https://utexas.campuslabs.com/engage/organization/QuizBowl), recreational [reading](https://www.goodreads.com/user/show/44370058-nathaniel) and mathematics (here's [a fun one I saw recently](https://www.janestreet.com/join-jane-street/open-positions/?utm_content=sierpinski)), eating spicy and/or fermented[^3] things in accordance with lax (read: lapsed) veganism[^21] (basically, I'll eat cheese if it's going to waste or especially difficult to avoid). As of August 2019, I now have two hens (Nina and Maria), both of whom lay eggs, which I also eat!
>>>>>>> f45d0e2296578ff24b402fcfe11f5570411bc3be
...
<center>
![](/cheddar_head.gif){width=50%}
<figcaption><font size="1">Cheddar, the new roo</font></figcaption>
</center>
...
[^37]: These "or" statements are inclusive (i.e., not xor)
[^38]: [Wife and I competed at the 2021 American Crossword Puzzle Tournament!](https://docs.google.com/spreadsheets/d/1lOyPqyAh6r2Q488U_Z_e2kUYerq0Op9QYBD_RBNwtn4/edit#gid=817209903)
...
world with waste?"  
* When, if ever, should freedoms be curtailed?
