...
My name is Nathaniel Woodward (*né* Raley) and I am a data science professional and former faculty member in [Statistics and Data Sciences](https://stat.utexas.edu/) at UT Austin, where I earned both PhD (2018) and MS (2016) while working as a researcher and statistical consultant.

I am interested in modern statistical approaches to causal inference, especially as they apply to evaluations of human behavior. In my research, I have drawn upon variety of data sources to investigate teaching effectiveness, curriculum redesign, pathways through college, and other questions important to university stakeholders. 
