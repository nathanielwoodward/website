...
I am currently a Lecturer in the [Department of Statistics and Data Sciences at UT Austin](https://stat.utexas.edu/), where I earned both PhD (2018) and MS (2016) and where I previously worked as a researcher and statistical consultant.
...
Furthermore, I have experience modeling the causal effect of large-scale interventions, including a nation-wide randomized effectiveness trial. I have also conducted laboratory studies with human subjects to test interventions designed to improve long-term retention and transfer of learning to new contexts. For some examples of my work, see the [portfolio](/portfolio/) page.
