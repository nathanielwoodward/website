...
I am a Lecturer in Statistics and Data Sciences at UT Austin, where I have previously worked as a researcher and statistical consultant.
...
<script type="text/javascript" src="/bigfoot.min.js"></script>
...
<center>![](/static/howIfeelwhen_meme1.png)
<figcaption><font size="1">Three ways I usually feel inside watching or participating in social interactions.</font></figcaption>
</center>
...
Besides, I like indoor activities best! I enjoy pestering my[^6] three[^7] cats,[^8] juggling,[^9] puzzling (sweeping mines,[^2] crossing words[^16]), [quizzing](https://utexas.campuslabs.com/engage/organization/QuizBowl), recreational [reading](https://www.goodreads.com/user/show/44370058-nathaniel) and mathematics (here's [a fun one I saw recently](https://www.janestreet.com/join-jane-street/open-positions/?utm_content=sierpinski)), eating spicy and/or fermented[^3] things in accordance with lax (read: lapsed) veganism[^21] (basically, I eat cheese if it's free, going to waste, difficult to avoid, etc.). 

<center>
![](../static/lisa_myinterests.jpg)
<figcaption><font size="1">Same.</font></figcaption>
</center>

If I were a nonhuman animal, I have it on good authority that I would be an umbrella cockatoo.[^4] 
I am a proponent of the Nordic theory of love.[^23]

My sense of *fremdschämen* on behalf of humanity can be socially crippling, and I get positively irate about the residue left behind after peeling stickers off of jars. Yes I like to juxtapose, but give me the [unity of opposites](https://en.wikipedia.org/wiki/Unity_of_opposites) any day.

I prefer my content in text form, and with few exceptions I don't like movies or TV.[^22] I especially hated the film Amadeus (but I very much enjoyed Wall\*E). [Vis-à-vis fiction](https://www.goodreads.com/user/show/44370058-nathaniel), the Recognitions is gospel and Suttree my book of sacred psalms. And though their respective Apostles have been perennially passed over for the prize (add Nabokov to their number), I think [Chris Onstad](http://www.ohnorobot.com/random.pl?comic=636) deserves the next Literature Nobel solely for his achievements in the genre of webcomics. 
...
[^20]: So fun!
[^22]: And despite their being "active" passtimes, I don't like "video games" much either, but if I did, I would like real-time strategy games or RPGs
[^23]: “That authentic love and friendship are possible only between individuals who are independent and equal.” 
[^24]: ...when Girl Talk released *Feed The Animals* and *All Day*, Lady Gaga was everywhere and everything, the New Pornographers had at least 3 amazing albums, Das Racist was still together...
