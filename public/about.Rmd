...
I am a Lecturer in the [Department of Statistics and Data Sciences at UT Austin](https://stat.utexas.edu/), where I earned both PhD (2018) and MS (2016) and where I previously worked as a researcher and statistical consultant.

I am interested in modern statistical approaches to causal inference, especially as they apply to evaluations of human learning and memory. In my research, I have used institutional data to investigate teaching effectiveness, curriculum redesign, students' pathways through college, and other questions important to university stakeholders. 

I have experience modeling the causal effect of large-scale interventions, including a nation-wide randomized effectiveness trial. I have also conducted laboratory studies with human subjects to test interventions designed to improve long-term retention and transfer of learning to new contexts. 

I am also interested in human--computer interaction, and I have experience applying psychometric techniques to adapively model latent traits (such as ability and mastery) based on peoples' interactions with technology (e.g., click-stream and other log data, biometric measurements) and using such models to inform predictions and to optimize training.
...
For some reason I have been listening to a lot of modern [music](/music) lately, and though indie rock and art pop predominate my streams, my tastes are pretty genre-catholic. I generally prefer music (catchy, orchestral, ethereal, weird, virtuosic) over lyrics.[^30] Lyrics that are overly literal are often quotidian and cringey to me and there is no surer way to spoil an otherwise-great song: Sometimes I'll really like a song until I understand the lyrics.[^31]  If I *have* to understand the words themselves, I like for them to be non-narrative, evocative, and imagery-rich (think Neutral Milk Hotel) or free-associationy melodic word-salad packed with references (think Das Racist, Panda Bear), or so vapid as to be entirely ignorable vectors for sound (most modern radio pop), or meaningful-sounding yet mostly meaningless stuff whose ambiguity lends itself to endless hermenuetics, particularly stuff of the sad-dad variety (think The National).
...
[^20]: So fun!
[^22]: I especially hated the film Amadeus (but I very much enjoyed Wall\*E). Despite their being "active" passtimes, I don't like video games much either, but if I did, I would like real-time strategy games or RPGs
...
[^30]: With rare exceptions, I'd rather the human voice be used instrumentally: When it's beautiful language I'm after, I'll read some poetry. 
[^31]:If Sigur Ros sang in english, I would probably hate it.
